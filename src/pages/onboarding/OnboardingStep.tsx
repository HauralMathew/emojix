...
export default function OnboardingStep({ onNext, onBack }: OnboardingStepProps) {
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-background overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-4xl px-4 pt-1 pb-12">
        ...
        <div className="w-full mb-20">
          ...
          <div className="flex justify-center mb-6 w-full">
            <div className="h-2 w-32 rounded-full bg-surface">
              <div className="h-2 rounded-full bg-primary transition-all duration-300" style={{ width: '50%' }} />
            </div>
          </div>
          {/* Title and subtitle */}
          <h2 className="text-3xl font-bold text-text mb-2 text-center">Choose Your Experience</h2>
          <p className="text-text/80 text-center max-w-md text-sm mx-auto">
            Select the option that best matches how you want to use Emojix. You can change this later in settings.
          </p>
        </div>
        {/* Cards */}
        <div className="flex flex-col md:flex-row gap-8 w-full">
          ...
          >
            <h3 className="text-2xl font-bold text-primary mb-4">Creator Mode</h3>
            {/* Skeleton Screen */}
            ...
            <p className="text-text/70 text-sm">Design and customize your own emoticon collections with advanced editing tools and creative freedom.</p>
          </div>
          ...
          <div 
            ...
            className="flex-1 bg-surface/20 backdrop-blur-xl rounded-2xl p-6 border border-white/10 cursor-pointer hover:scale-105 transition-all duration-300 hover:border-primary/30 group"
          >
            <h3 className="text-2xl font-bold text-primary mb-4">Explorer Mode</h3>
            {/* Skeleton Screen */}
            <div className="bg-background/50 rounded-lg p-4 mb-4 border border-white/5">
            ...
            <p className="text-text/70 text-sm">Discover and use pre-made emoticon packs with a simple, intuitive interface for quick access.</p>
          </div>
        </div>
      </div>
